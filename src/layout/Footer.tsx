...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-50 pt-16 pb-6 text-gray-700 relative">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4">
              <Link href="#" className="block w-32 h-10">
                <Image
      ...
      {/* <button
        className="fixed bottom-6 right-6 bg-gray-600 hover:bg-gray-700 text-white rounded-full h-10 w-10 z-50 flex items-center justify-center font-bold"
